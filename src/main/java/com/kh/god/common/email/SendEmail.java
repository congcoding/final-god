...
public class SendEmail {
  ...
  public void mailSendingForPwd(String email , String name , String pwd) {
	  String host = "smtp.naver.com"; // 네이버일 경우 네이버 계정, gmail경우 gmail 계정
	  final String USER = "escape_if_you_can@naver.com"; // 이메일 주소
	  final String PASSWORD = "escapeifyoucan!"; // 비밀번호
	  ...
	  try {
		  ...
		  message.setSubject("<GodOFDelivery> "+name+"고객님의 임시비밀번호 입니다."); // 메일 제목
		  message.setText("고객님의 임시 비밀번호는"+pwd+"입니다. 임시 비밀번호로 로그인 후 새로운 비밀번호를 변경해주세요."); // 메일 내용
