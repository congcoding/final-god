...
function bFlagCheck(sellerId,bFlag){
	...
	location.href = "${pageContext.request.contextPath}/admin/sellerBlackList.do?sellerId="+sellerId+"&bFlag="+bFlag+"&page=BList";
		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<div id="head-container">
					...
					<div id="sellerBL" class="alert-info" onclick="fn_goSellerBL();">판매자 BL</div>
				</div>
						...
						<c:forEach items="${list }" var="s">
							...
							<tbody>
								...
								<tr>
									...
									<td name="sellerId" id="sellerId">${s.sellerId }</td>
									<td name="sellerName" id="sellerName">${s.sellerName }</td>
									...
									<td>
										...
										<input type="button" class="btn btn-info" value="해제" onclick="bFlagCheck('${s.sellerId }','${s.blackFlag }');" />
									</td>
				...
				<div id="pageBar">
					<%=com.kh.god.common.util.Utils.getPerBar(totalContents, cPage, numPerPage, "sellerBList.do")%>
				</div>
