...
<!-- Page Wrapper -->
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800" id="currentOrder"></div>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id="currentReview"></div>
                    </div>
                    <div class="col-auto">
  ...
  function saleVolume(types){
	  $.ajax({
		  url : "${pageContext.request.contextPath}/seller/totalSaleVolume.do",
		  ...
		  success : function(data){
				  ...
				  if(types === 'week'){
			  		$("#lastWeekSaleVolume").html(numberWithCommas(totalPrice)+'원');
				  }else if(types === 'month'){
