        ...
        <div class="container-fluid">
		  ...
		  <div class="card">
		    <div class="card-header" role="tab" id="headingOne">
		      <h5 class="mb-0">
		        <a data-toggle="collapse" href="#collapseOne${status.count}" aria-expanded="true" aria-controls="collapseOne">
		          <span>'${review1.writer}'</span>님의 리뷰
		        </a>
		          <button type="button" class="btn btn-outline-info">쿠폰지급</button>
		      </h5>
		    </div>

		    <div id="collapseOne${status.count}" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
		      <div class="comment">
		      ...
		      <!-- 리뷰답댓 -->     
		      <br>
		      <input type="email" class="form-control" id="reply" aria-describedby="emailHelp" placeholder="Enter email">
