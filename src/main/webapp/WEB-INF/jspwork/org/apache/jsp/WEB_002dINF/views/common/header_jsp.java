...
<<<<<<< HEAD
 * Generated at: 2019-03-08 09:45:04 UTC
=======
 * Generated at: 2019-03-07 06:44:24 UTC
>>>>>>> 76c7db561c4793f98325042719fb526552357dde
...
<<<<<<< HEAD
      ...
      out.write("\t\t\t \t\tconsole.log(messageData);\r\n");
...
=======
      ...
      out.write("\t //채팅방 목록 구현\n");
      out.write("\t $(\"#messagesDropdown\").on('click',function(){\n");
      out.write("\t\t console.log(\"목록 누를때 접속한 모든 유저들!: \"+connectUser);\n");
      out.write("\t\tif($(\"#messagesDropdown\").attr('aria-expanded') === 'false'){\n");
      out.write("\t\t\t$.ajax({\n");
      out.write("\t\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\tif(init == 0){\n");
      out.write("\t\t\t\t\t\t\tchatUserList.push(chatPerson);\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\tif(connectUser.length != 0){\n");
      out.write("\t\t\t\t\t\t\tconsole.log(\"채팅방 목록 만들기전에 들어옴\");\n");
      out.write("\t\t\t\t\t\t\tfor(var j in connectUser){\n");
      out.write("\t\t\t\t\t\t\t\tif(connectUser[j] == chatPerson){\n");
...
=======
      ...
      out.write("\t\t\t\tconsole.log(\"채팅방 목록 만들기전에 들어옴\");\n");
      out.write("\t\t\t\tfor(var j in connectUser){\n");
      out.write("\t\t\t\t\tif(connectUser[j] == youId){\n");
      out.write("\t\t\t\t\t\t//console.log(\"접속중!\");\n");
      out.write("\t\t\t\t\t\tchatHeader = $(\"<div class='modal-header'> <h5 class='modal-title' id='exampleModalLabel'></h5>\t<div class='profileImage'><div class='status-indicator bg-success' id='memberstatus'><i class='far fa-grin' id='profileImage' ></i></div><div id='communicateWith'>\"+ youId +\"</div></div><button type='button' class='close' data-dismiss='modal' aria-label='Close' style='padding : 0.1em;'><span aria-hidden='true'>&times;</span></button></div>\");\n");
      out.write("\t\t\t\t\t\tbreak;\n");
      out.write("\t\t\t\t\t}else{\n");
      ...
      out.write("\tvar timeStamp = \"\";\n");
      out.write("\tvar messageCount = 0;\n");
      out.write("\tvar connectUser = new Array();\n");
      out.write("\t//소켓으로 서버가 클라이언트한테 전달한 값을 바탕으로 만들어냄\n");
      out.write("\tfunction receiveMessage(alertType,messageType){\n");
      out.write("\t\tconsole.log(\"메세지 전송 후 : \"+alertType+\" : \"+messageType);\n");
      out.write("\t\t // 받는 사람이 현재 그 채팅방을 보고 있으면 알람을 주지 않고 메세지를 보냄.\n");
...
=======
      ...
      out.write("\t\t \t\t}else if(message[i] === \"realTimeMember\"){\n");
      out.write("\t\t \t\t\tfor(var j = 1; j < message.length; j++){\n");
      out.write("\t\t \t\t\t\tconsole.log(message[j]);\n");
      out.write("\t\t \t\t\t\tconnectUser.push(message[j]);\n");
      out.write("\t\t \t\t\t}\n");
      out.write("\t\t \t\t\tconsole.log(\"실시간 chatUserList: \"+chatUserList);\n");
      out.write("\t\t \t\t\tconsole.log(\"실시간 connectUser: \"+connectUser);\n");
      out.write("\t\t \t\t\t//실시간으로 바꿔줌.\n");
      out.write("\t\t \t\t\tfor(var j = 0; j < chatUserList.length; j++){\n");
      out.write("\t\t \t\t\t\tfor(var k = 0; k < connectUser.length; k++){\n");
      out.write("\t\t \t\t\t\t\tvar chatUser = chatUserList[j];\n");
      out.write("\t\t \t\t\t\t\tconsole.log(\"실시간 connect \"+connectUser[k]);\n");
      out.write("\t\t\t \t\t\t\tif(chatUser == connectUser[k]){\n");
      out.write("\t\t\t \t\t\t\t\t$(\"div[id^=messageView]\").each(function(i){\n");
      out.write("\t\t\t \t\t\t\t\t\tvar loginSeller = $(\"#messageView\"+i).children().eq(0).text();\n");
      out.write("\t\t\t \t\t\t\t\t\tconsole.log(\"dd : \"+loginSeller);\n");
      out.write("\t\t\t \t\t\t\t\t\tif(loginSeller === chatUserList[j]){\n");
      out.write("\t\t\t \t\t\t\t\t\t\t$(\"#messageView\"+i).children().children().eq(0).attr(\"class\",\"status-indicator bg-success\");\n");
      out.write("\t\t\t \t\t\t\t\t\t}\n");
      out.write("\t\t\t \t\t\t\t\t});\n");
      out.write("\t\t\t \t\t\t\t\t$(\"#memberstatus\").attr(\"class\",\"status-indicator bg-success\");\n");
      out.write("\t\t\t \t\t\t\t}else{\n");
      out.write("\t\t\t \t\t\t\t\t$(\"div[id^=messageView]\").each(function(i){\n");
      out.write("\t\t\t \t\t\t\t\t\tvar loginSeller = $(\"#messageView\"+i).children().eq(0).text();\n");
      out.write("\t\t\t \t\t\t\t\t\tconsole.log(\"ss : \"+loginSeller);\n");
      ...
      out.write("\t\t\t \t\t\t\t\t\t}\n");
      out.write("\t\t\t \t\t\t\t\t});\n");
      out.write("\t\t\t \t\t\t\t\t$(\"#memberstatus\").attr(\"class\",\"status-indicator bg-light\");\n");
      out.write("\t\t\t \t\t\t\t}\n");
      out.write("\t\t \t\t\t\t}\n");
      out.write("\t\t \t\t\t}\n");
      out.write("\t\t \t\t\tbreak;\n");
...
>>>>>>> 76c7db561c4793f98325042719fb526552357dde
  ...
  private boolean _jspx_meth_c_005fif_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f4, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/common/header.jsp(289,6) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
>>>>>>> 76c7db561c4793f98325042719fb526552357dde
  ...
  private boolean _jspx_meth_c_005fif_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/common/header.jsp(365,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sellerLoggedIn != null}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
...
<<<<<<< HEAD
  ...
  private boolean _jspx_meth_c_005fif_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f6, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/common/header.jsp(366,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
>>>>>>> 76c7db561c4793f98325042719fb526552357dde
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/common/header.jsp(904,24) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
